#ifndef _SETPARENTTREEVISITOR_H_
#define _SETPARENTTREEVISITOR_H_

#include "TreeVisitor.h"

#include "ValueStack.h"

class SetParentTreeVisitor : public TreeVisitor {
private:
...
#define IMPL_VISIT(type) \
    void Visit##type(const Object &node) override { SetParent(node); }
    IMPL_VISIT(Program)
